...
Order:
1. `python3 week03/build/gen_figs.py`            → regenerates figures into `week03/figs/` (Week 2: into `week03/` + `week03/shots/`)
2. `python3 week03/build/build_data_bank_xlsx.py` → rebuilds `Week03_Data_Bank.xlsx` from the JSON banks
3. `python3 week03/build/build_notes.py`         → rebuilds the lecture notes
